...
try{
    ...
    const paymentResponse = await axios.post('http://100.24.69.111:3003/paymentprocess')
    ...
    const notificationResponse = await axios.post('http://54.80.0.52:3004/sendnotification', {
